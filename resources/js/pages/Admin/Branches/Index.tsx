        ...
        <AppLayout>
            ...
            <div className="mx-auto flex w-full max-w-[1600px] flex-1 flex-col gap-6 p-6 lg:p-10">
                ...
                <div className="flex flex-col gap-4 md:flex-row md:items-center justify-between">
                    <div>
                        <h1 className="text-4xl font-black tracking-tight text-foreground">Network Nodes</h1>
                        <p className="mt-1 italic text-muted-foreground">Configure and oversee physical service locations</p>
                    </div>
                    <Button 
                ...
                {/* === MAIN TABLE CARD === */}
                <Card className="overflow-hidden rounded-[2rem] border-none bg-card shadow-sm text-card-foreground">
                            ...
                            <Table>
                                <TableHeader className="bg-muted/50">
                                    <TableRow className="border-none hover:bg-transparent">
                                        <TableHead className="w-[80px] py-5 pl-8 font-bold text-muted-foreground">ID</TableHead>
                                        <TableHead className="font-bold text-muted-foreground">Branch Identity</TableHead>
                                        <TableHead className="font-bold text-muted-foreground">Location Details</TableHead>
                                        <TableHead className="pr-8 text-right font-bold text-muted-foreground">Management</TableHead>
                                    </TableRow>
                                </TableHeader>
                                <TableBody>
                                    <AnimatePresence mode="popLayout">
                                        {filteredBranches.map((branch) => (
                                            ...
                                            >
                                                <TableCell className="font-mono text-muted-foreground/60 pl-8">#{branch.id}</TableCell>
                                                <TableCell>
                                                ...
                                                <TableCell className="text-muted-foreground">
                                                    <div className="flex items-center gap-2 text-sm">
                                                        ...
                                                        {branch.address || <span className="italic text-muted-foreground/40">No address provided</span>}
                                                    </div>
                                                </TableCell>
                                                ...
                                                <TableCell className="pr-8 text-right">
                                                    <div className="flex justify-end gap-2">
                                                        ...
                                                        <Button 
                                                            variant="ghost" 
                                                            size="icon" 
                                                            onClick={() => { setDeletingId(branch.id); setIsDeleteModalOpen(true); }} 
            ...
            <Dialog open={isModalOpen} onOpenChange={toggleModal}>
                <DialogContent className="overflow-hidden border-none p-0 shadow-2xl sm:max-w-lg rounded-[2.5rem] bg-card text-card-foreground">
                    <form onSubmit={handleSubmit}>
                        <div className="bg-primary p-8 text-primary-foreground">
                            <DialogTitle className="text-2xl font-black">
                                {editingBranch ? 'Update Node' : 'Register New Node'}
                            </DialogTitle>
                        ...
                        <div className="space-y-6 p-8 bg-card">
                            <div className="space-y-2">
                                ...
                                <Input 
                                    ...
                                    className="h-12 border-none bg-muted rounded-xl focus-visible:ring-ring" 
                        ...
                        <DialogFooter className="mt-0 bg-muted/50 p-8">
                            <Button 
                                ...
                                className="text-xs font-black uppercase tracking-widest text-muted-foreground hover:bg-transparent hover:text-foreground"
                            >
                                Dismiss
                            </Button>
                            <Button 
            ...
            <Dialog open={isDeleteModalOpen} onOpenChange={setIsDeleteModalOpen}>
                <DialogContent className="rounded-[2rem] bg-card text-card-foreground border-none">
                    <DialogHeader>
                        ...
                        <DialogDescription className="py-4 text-muted-foreground">
                            ...
                            <span className="block mt-2 font-bold text-destructive">
                                This will disconnect all linked counters and historical feedback data immediately.
                            </span>
                        </DialogDescription>
                    </DialogHeader>
